...
public class UpdateStatusTest {
  ...
  private UpdateStatus servletUnderTest;
  @Before
  public void setUp() throws Exception {
    MockitoAnnotations.initMocks(this);
    helper.setUp();
    servletUnderTest = new UpdateStatus();
  }
  ...
  public void updateStatusTest() throws Exception {
   ...
   Entity book = new Entity("Books",6758376219876267L);
      ...
      servletUnderTest. updateBookStatus(str);
      Query qry = new Query("Books");  
      PreparedQuery pr = ds.prepare(q);
      Entity result1 = pr.asSingleEntity();
      assertEquals("Unavailable",result1.getProperty("Status"));
