...
public class AddDataToMemcacheTest {

    private final LocalServiceTestHelper helper =
    new LocalServiceTestHelper(new LocalMemcacheServiceTestConfig());

 private AddDataToMemcache servletUnderTest;
 ...
 @Mock private HttpServletResponse mockResponse;
  ...
  public void setUp() throws Exception {
    ...
    helper.setUp();
    String data =  "{\"Book Name\":\"The Wing\",\"Author Name\":\"Paulo cohelo\",\"Publisher Name\":\"Halper Caplins\",\"No Of Pages\":\"200\",\"Date\":\"22-03-2021\"}";
    when(mockRequest.getParameter("dataMap")).thenReturn(data);
    servletUnderTest = new AddDataToMemcache();
  ...
  public void getNameTest() throws Exception{
    ...
    Map<String,Object> map3 = new HashMap<String, Object>();
     map3 = (Map)result.get(0);
     assertEquals("The Wing",map3.get("Book Name"));
